...
//     version 1.14.0
//     from Assets/InputSystem/SnackInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputSystem/SnackInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @SnackInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @SnackInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""SnackInputActions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@SnackInputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, SnackInputActions.Player.Disable() has not been called.");
    }
    ...
    {
        private @SnackInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@SnackInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
